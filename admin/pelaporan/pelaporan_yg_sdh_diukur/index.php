<?php $title = "Pelaporan Yang Sudah Diukur";
                    ...
                    <div class="container-fluid">
                        <ol>
                            <li class="breadcrumb-item">
                               <h3> Pelaporan Yang Sudah Diukur</h3>
                            </li>
                        </ol>
...
function tampil_data($koneksi){
	...
	$nomor = 1;
		...
		echo "<fieldset>";
		echo "<p class='text-center'>Pendaftaran Tanah Sistematis Lengkap (PTSL) Selesai Pengukuran</p>";
		echo "<hr>";
		...
		echo "<thead>";
			...
			echo "<th>No</th>
				...
				<th>K4</th>
				<th>Total Persil</th>
				<th>Luas Yang di Mohon M2</th>
				<th>Luas Pengukuran M2</th>";	
			echo "</tr>";
		echo "</thead>";
		echo "<tbody>";
